...
def get_feature_map(dataset, save_base_path="."):
    feature_file = open(f"{save_base_path}/data/{dataset}/list.txt", "r")
    feature_list = []
...
def get_fc_graph_struc(dataset, save_base_path="."):
    feature_file = open(f"{save_base_path}/data/{dataset}/list.txt", "r")
...
def get_prior_graph_struc(dataset, save_base_path="."):
    feature_file = open(f"{save_base_path}/data/{dataset}/features.txt", "r")
